...
PALM_ANALYSIS_PROMPT = """당신은 전문 손금 분석가입니다. 이 손바닥 사진을 직접 관찰하여 손금을 읽어주세요.

사진에서 실제로 보이는 손금선의 길이, 깊이, 곡선, 갈래, 끊김 등을 관찰하고, 그에 따라 점수와 해석을 판단하세요. 모든 사진에 같은 점수를 주지 마세요. 사진마다 다르게 평가하세요.
...

{
  ...
  "lines": {
    "heart_line": {
      "name": "감정선",
      "description": "사진에서 관찰한 감정선의 구체적 특징과 의미 (2-3문장, 한국어)",
      "score": 50~100 사이의 정수 (사진에서 관찰한 선의 깊이/길이/선명도에 따라 판단),
      "keywords": ["키워드1", "키워드2", "키워드3"]
    },
    "head_line": {
      "name": "두뇌선",
      "description": "사진에서 관찰한 두뇌선의 구체적 특징과 의미 (2-3문장, 한국어)",
      "score": 50~100 사이의 정수,
      "keywords": ["키워드1", "키워드2", "키워드3"]
    },
    "life_line": {
      "name": "생명선",
      "description": "사진에서 관찰한 생명선의 구체적 특징과 의미 (2-3문장, 한국어)",
      "score": 50~100 사이의 정수,
      "keywords": ["키워드1", "키워드2", "키워드3"]
    },
    "fate_line": {
      "name": "운명선",
      "description": "사진에서 관찰한 운명선의 구체적 특징과 의미 (2-3문장, 한국어). 운명선이 보이지 않으면 그 의미를 설명",
...
중요: score는 반드시 정수로, 사진에서 실제 관찰한 손금 상태에 따라 차등 부여하세요. 4개 선이 모두 같은 점수가 되면 안 됩니다. 반드시 위 JSON 형식을 정확히 지켜주세요."""
